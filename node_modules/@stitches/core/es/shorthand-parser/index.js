...
var emptyTokens = {};
tokenTypes.forEach(function (type) { return (emptyTokens[type] = {}); });
/*
...
export var background = createPropertyParser(function (tokens, css, value, index, chain, chainIndex, chains) {
    if (value === "/") {
        return;
    }
...
export var animation = createPropertyParser(function (_, css, value, index, chain) {
...
export var font = createPropertyParser(function (tokens, css, value) {
...
export var transition = createPropertyParser(
...
export var margin = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
...
export var padding = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
...
export var border = createPropertyParser(function (tokens, css, value) {
...
export var borderTop = createPropertyParser(function (tokens, css, value) {
    if (value.match(/none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset/)) {
        css.borderTopStyle = value;
    }
...
export var borderRight = createPropertyParser(function (tokens, css, value) {
    if (value.match(/none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset/)) {
        css.borderRightStyle = value;
    }
    else if (value.match(unitMatch) || tokens.borderWidths[value]) {
...
export var borderLeft = createPropertyParser(function (tokens, css, value) {
    if (value.match(/none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset/)) {
        css.borderLeftStyle = value;
    }
    else if (value.match(unitMatch) || tokens.borderWidths[value]) {
...
export var borderBottom = createPropertyParser(function (tokens, css, value) {
    if (value.match(/none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset/)) {
        css.borderBottomStyle = value;
    }
    else if (value.match(unitMatch) || tokens.borderWidths[value]) {
...
export var borderWidth = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
        css.borderTopWidth = tokens.borderWidths[value] || value;
        css.borderRightWidth = tokens.borderWidths[value] || value;
        css.borderBottomWidth = tokens.borderWidths[value] || value;
...
export var borderColor = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
        css.borderTopColor = tokens.colors[value] || value;
        css.borderRightColor = tokens.colors[value] || value;
        css.borderBottomColor = tokens.colors[value] || value;
...
export var borderStyle = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
        css.borderTopStyle = value;
        css.borderRightStyle = value;
        css.borderBottomStyle = value;
...
export var borderRadius = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
...
export var boxShadow = function (tokens, value) {
    return {
