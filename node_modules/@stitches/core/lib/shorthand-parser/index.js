...
exports.boxShadow = exports.borderRadius = exports.borderStyle = exports.borderColor = exports.borderWidth = exports.borderBottom = exports.borderLeft = exports.borderRight = exports.borderTop = exports.border = exports.padding = exports.margin = exports.transition = exports.font = exports.animation = exports.background = void 0;
var constants_1 = require("../constants");
var value_tokenizer_1 = require("./value-tokenizer");
...
var emptyTokens = {};
constants_1.tokenTypes.forEach(function (type) { return (emptyTokens[type] = {}); });
/*
...
var createPropertyParser = function (type) { return function (tokens, value) {
    var chains = typeof value === "number" ? [[value]] : value_tokenizer_1.tokenizeValue(value);
    var css = {};
    // TODO: refactor this
...
exports.background = createPropertyParser(function (tokens, css, value, index, chain, chainIndex, chains) {
    if (value === "/") {
        return;
    }
...
exports.animation = createPropertyParser(function (_, css, value, index, chain) {
...
exports.font = createPropertyParser(function (tokens, css, value) {
...
exports.transition = createPropertyParser(
...
exports.margin = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
...
exports.padding = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
...
exports.border = createPropertyParser(function (tokens, css, value) {
...
exports.borderTop = createPropertyParser(function (tokens, css, value) {
    if (value.match(/none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset/)) {
        css.borderTopStyle = value;
    }
...
exports.borderRight = createPropertyParser(function (tokens, css, value) {
    if (value.match(/none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset/)) {
        css.borderRightStyle = value;
    }
    else if (value.match(unitMatch) || tokens.borderWidths[value]) {
...
exports.borderLeft = createPropertyParser(function (tokens, css, value) {
    if (value.match(/none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset/)) {
        css.borderLeftStyle = value;
    }
    else if (value.match(unitMatch) || tokens.borderWidths[value]) {
...
exports.borderBottom = createPropertyParser(function (tokens, css, value) {
    if (value.match(/none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset/)) {
        css.borderBottomStyle = value;
    }
    else if (value.match(unitMatch) || tokens.borderWidths[value]) {
...
exports.borderWidth = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
        css.borderTopWidth = tokens.borderWidths[value] || value;
        css.borderRightWidth = tokens.borderWidths[value] || value;
        css.borderBottomWidth = tokens.borderWidths[value] || value;
...
exports.borderColor = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
        css.borderTopColor = tokens.colors[value] || value;
        css.borderRightColor = tokens.colors[value] || value;
        css.borderBottomColor = tokens.colors[value] || value;
...
exports.borderStyle = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
        css.borderTopStyle = value;
        css.borderRightStyle = value;
        css.borderBottomStyle = value;
...
exports.borderRadius = createPropertyParser(function (tokens, css, value, index) {
    if (index === 0) {
...
exports.boxShadow = function (tokens, value) {
    return {
        boxShadow: value_tokenizer_1.tokenizeValue(value)
