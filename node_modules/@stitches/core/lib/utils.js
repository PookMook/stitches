...
exports.hashString = exports.getVendorPrefixAndProps = exports.specificityProps = exports.createSheets = exports.tokenTypes = exports.cssPropToToken = exports.MAIN_BREAKPOINT_ID = void 0;
var tslib_1 = require("tslib");
var shorthand_parser_1 = require("./shorthand-parser");
exports.MAIN_BREAKPOINT_ID = "initial";
...
exports.createSheets = function (env, screens) {
    ...
    if (env && env.document) {
        ...
        return {
            tags: tags,
            sheets: ["__variables__", exports.MAIN_BREAKPOINT_ID]
...
exports.specificityProps = {
    border: shorthand_parser_1.border,
    boxShadow: shorthand_parser_1.boxShadow,
    flex: function (tokens, value) {
        if (Array.isArray(value)) {
            if (value.length === 2) {
                return tslib_1.__assign({ flexGrow: value[0] }, (isNaN(value[1])
                    ? { flexBasis: value[1] }
                    : { flexShrink: value[1] }));
            }
            if (value.length === 3) {
    ...
    margin: shorthand_parser_1.margin,
    padding: shorthand_parser_1.padding,
    borderRadius: shorthand_parser_1.borderRadius,
    borderColor: shorthand_parser_1.borderColor,
    borderStyle: shorthand_parser_1.borderStyle,
    borderWidth: shorthand_parser_1.borderWidth,
    background: shorthand_parser_1.background,
    animation: shorthand_parser_1.animation,
    transition: shorthand_parser_1.transition,
    font: shorthand_parser_1.font,
    borderBottom: shorthand_parser_1.borderBottom,
    borderLeft: shorthand_parser_1.borderLeft,
    borderTop: shorthand_parser_1.borderTop,
    borderRight: shorthand_parser_1.borderRight,
};
exports.getVendorPrefixAndProps = function (env) {
