...
var core_1 = require("@stitches/core");
var React = require("react");
var hasWarnedInlineStyle = false;
var createCompoundVariantsMatcher = function (breakPoints, existingMap) {
    var map = new Map();
    map.set(core_1.MAIN_BREAKPOINT_ID, tslib_1.__spreadArrays(((existingMap === null || existingMap === void 0 ? void 0 : existingMap.get(core_1.MAIN_BREAKPOINT_ID)) || [])));
    Object.keys(breakPoints).forEach(function (breakpoint) {
        return map.set(breakpoint, tslib_1.__spreadArrays(((existingMap === null || existingMap === void 0 ? void 0 : existingMap.get(breakpoint)) || [])));
    });
    return map;
};
exports.createStyled = function (config) {
    var css = core_1.createCss(config);
    var defaultElement = "div";
    var Box = React.forwardRef(function (props, ref) {
        var Element = props.as || defaultElement;
        return React.createElement(Element, tslib_1.__assign(tslib_1.__assign({ ref: ref }, props), { as: undefined }));
    });
    var currentAs;
    ...
    var styledInstance = function (baseAndVariantStyles, Component) {
        ...
        var as = currentAs;
        var _a = baseAndVariantStyles.variants, variants = _a === void 0 ? {} : _a, base = tslib_1.__rest(baseAndVariantStyles, ["variants"]);
        ...
        var stitchesComponentId = "scid-" + core_1.hashString(JSON.stringify(baseAndVariantStyles));
        var StitchesComponent = React.forwardRef(function (props, ref) {
            ...
            var _loop_1 = function (key) {
                ...
                if (key in variants) {
                    ...
                    var keyVal_1 = props[key] && typeof props[key] !== "object"
                        ? (_a = {}, _a[core_1.MAIN_BREAKPOINT_ID] = props[key], _a) : props[key];
            ...
            return React.createElement(Component, tslib_1.__assign(tslib_1.__assign({}, propsWithoutVariantsAndCssProp), { as: props.as || as, ref: ref, className: css.apply(void 0, tslib_1.__spreadArrays([stitchesComponentId], compositions, [props.className])) }));
        });
...
function evaluateStylesForAllBreakpoints(styleObject, configBreakpoints, css) {
    var _a, _b;
    var breakpoints = (_a = {},
        _a[core_1.MAIN_BREAKPOINT_ID] = css(styleObject),
        _a);
